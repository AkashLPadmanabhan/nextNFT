import { MagnifyingGlassIcon, ShoppingBagIcon, UserIcon, UsersIcon } from '@heroicons/react/16/solid'
    ...
    <div className='h-[12vh] bg-[#111D5e]'>
        <div className='w-[90%] flex items-center h-[100%] justify-between mx-auto'>
            <h1 className='text-[20px] sm:text-[30px] text-white'>
                next<span className='text-yellow-300'>NFT</span>.
            </h1>
            <div className='flex items-center space-x-4'>
               <div className='h-[50%] hidden md:block relative text-black p-2 bg-gray-100 rounded-lg'>
                ...
                <div className='w-[2rem] hover:bg-red-600 cursor-pointer transition-all duration-200 h-[2rem] sm:w-[3.4rem] sm:h-[3.4rem] rounded-full flex items-center justify-center bg-[#0000003d]'>
                    <UserIcon className='w-[1.3rem] h-[1.3rem] text-white'/>
                </div>
                <div className="w-[2rem] hover:bg-red-600 relative cursor-pointer transition-all duration-200 h-[2rem] sm:w-[3.4rem] sm:h-[3.4rem] rounded-full flex items-center justify-center bg-[#0000003d]">
